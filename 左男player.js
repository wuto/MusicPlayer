...
if (navigator['userAgent']['match'](/(iPhone|iPod|Android|ios|Nokia|Black Berry|MIDP|Phone)/i)) {
	...
	if (top['location'] != self['location']) {
		...
		$albumList = $('.album-list', $player), $songFrom = $('.player .artist', $player), $songFrom1 = $('.player .artist1', $player), $songFrom2 = $('.player .moshi', $player), $songFrom3 = $('.player .geci', $player), $songFrom4 = $('.player .switch-ksclrc', $player), songFrom33 = '开启', songFrom44 = '', songFrom55 = '', roundcolor = '#6c6971', lightcolor = '#81c300', cur = 'current', files = '../music/', api = 'content/plugins/emzl_mp3/other/music.php', user = '/?plugin=emzl_mp3', volume = $['cookie']('myhk_player_volume') ? $['cookie']('myhk_player_volume') : '.55', albumId = 0x0, songId = 0x0, songTotal = 0x0, showLrc = true, random = true, hasgeci = true, ycgeci = true, hasdefault = false, musicfirsttip = false;
		...
		var cicleTime = null;
		$cover['html']('<img src="/content/plugins/emzl_mp3/style/kmiwz.com.jpg">');
	...
	$['ajax']({
		...
		success: function(infos) {
			...
			coverImg['error'] = function() {
				...
				coverImg['src'] = 'content/plugins/emzl_mp3/style/kmiwz.com.jpg';
				setTimeout(function() {
